...
C#에서는 DI가 비교적 자연스럽게 적용되지만, Unity에서는 몇 가지 구조적인 제약 때문에 DI를 도입하는 데 어려움이 있다. 특히 MonoBehaviour 기반 구조, 생명주기 관리, GameObject 종속성 등이 복합적으로 작용하며 일반적인 DI 방식과 충돌한다.

<center>
<img src="{{img_url}}/img_06.gif" style="max-width:253px; width:100%;">
